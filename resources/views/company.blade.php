                        ...
                        <div class="container-fluid">
                            <div class="main-title d-flex align-items-center justify-content-between">
                                <h1>Company Status</h1>
                                    ...
                                    <a href="#" data-bs-target="#addcompanymodal" id="addcompanyModalbtn" data-bs-toggle="modal" class="btn btn-primary">Add Company</a>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($company as $value)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="" class="link-icon"><i class="fas fa-trash" id="deletecompanybtn" data-id="{{$value->companyId}}"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                ...
                <div class="modal-body">
                    <form action="" id="addcompanyform">
                        <div class="input-wrapper mb-3">
                            <input type="url" class="form-control w-100" id="logourl" name="logourl" placeholder="Logo URL">
                        </div>
                        <div class="input-wrapper mb-3">
                            <input type="text" class="form-control w-100" id="companyname" name="companyname" placeholder="Company Name">
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="input-wrapper mb-3">
                                    <input type="text" class="form-control w-100" id="shortname" name="shortname" placeholder="Short Name">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="input-wrapper mb-3">
                                    <input type="text" class="form-control w-100" id="shareprofit" name="shareprofit" placeholder="Share Profit">
                                </div>
                            </div>
                            <div class="input-wrapper mb-3">
                                <input type="text" class="form-control w-100" id="income" name="income" placeholder="Income">
                            </div>
                        </div>
