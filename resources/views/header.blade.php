    ...
    <div class="main">
        <div class="main-content">
            <div id="sidebar" class="sidebar">
                <a class="sidebar-brand" href="https://thugidash.stock-wise.online/dashboard"><img
                        src="{{ asset('assets/img/png/logo.png') }}" alt=""></a>
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a href="{{ route('transactionpage') }}" class="nav-link">
                            <img class="dark" src="{{ asset('assets/img/svg/transaction-solid.svg') }}"
                                alt="">
                            <img class="light" src="{{ asset('assets/img/svg/transaction-dark.svg') }}"
                                alt="">
                    ...
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center">
                                <a href="" class="notification active"><img
                                        src="{{ asset('assets/img/svg/notifiction.svg') }}" alt=""></a>
                                <div class="position-relative">
                                    <a class="user-img active" type="button" data-bs-toggle="dropdown"
                                        aria-expanded="false">
                                        <img
                                            src="https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880 alt="">
                                    </a>
