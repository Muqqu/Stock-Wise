...
<div class="container-fluid">
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                <a href="https://stock-wise.online/ci_api/{{ $value->screenshotImage }}"
                                    target="_blank">
                                    <img class="logo"
                                        src="https://stock-wise.online/ci_api/{{ $value->screenshotImage }}"
                                        alt="">
                                </a>
                        </td>
                        <!-- <div>
    ...
    <td>
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            <a class="link-icon editbtn" data-bs-toggle="modal" data-bs-target="#transactionModal" href="#"
                data-id="{{ $value->transectionId }}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="input-wrapper mb-3">
                    <input type="text" class="form-control w-100" id="amount" name="amount" value=""
