                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                                                        <a class="link-icon editwithdrawbtn" data-bs-toggle="modal" data-bs-target="#withdrawModal" href="#" data-id="{{$value->withdrawRequestId}}">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <a href="" class="link-icon" id="deletewithdrawbtn" data-id="{{$value->withdrawRequestId}}"><i class="fas fa-trash"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
                ...
                <form action="" id="withdrawdetail">
                    ...
                    <h5 class="text" id="withdrawdate">Date: <span></span></h5>
                        ...
                        <div class="input-wrapper my-3">
                            <input type="text" id="withdrawamount" class="form-control w-100" value placeholder="Enter amount">
                        </div>
